...
addToCartBtn.forEach(btn => {
    ...
    btn.addEventListener("click", () => {
        ...
        const product = {
            id: parentElement.querySelector("#product__id1,#product__id2,#product__id3,#product__id,#product__id4,#product__id5,#product__id6").value,
            name: parentElement.querySelector(".product__name").innerText,
            image: parentElement.querySelector("#image1,#image2,#image3,#image4,#image5,#image6").getAttribute("src"),
